    ...
    <div class="container mt-5">
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                <input type="file" name="sk_pangkat_terakhir" class="form-control" id="inputGroupFile1">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                <input type="file" name="sk_fungsional_terakhir" class="form-control" id="inputGroupFile2">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                <input type="file" name="sk_pencantuman_gelar" class="form-control" id="inputGroupFile3">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                <input type="file" name="ijazah_terakhir" class="form-control" id="inputGroupFile4">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                <input type="file" name="str" class="form-control" id="inputGroupFile5">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                <input type="file" name="sip" class="form-control" id="inputGroupFile6">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                <input type="file" name="surat_rekomendasi" class="form-control" id="inputGroupFile7">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                <input type="file" name="portofolio" class="form-control" id="inputGroupFile8">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                <input type="file" name="skp" class="form-control" id="inputGroupFile9">
            </div>
        </div>
